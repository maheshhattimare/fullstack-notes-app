  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center">
      <div className="text-center">
        ...
        <div className="absolute bottom-20 right-20 w-24 h-24 bg-gradient-to-br from-blue-500/5 to-emerald-500/5 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
    </div>
  );
};

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 py-12 lg:px-20 xl:px-32 relative">
        {/* Background Elements */}
        <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-purple-500/10 to-blue-500/10 dark:from-purple-400/20 dark:to-blue-400/20 rounded-full blur-xl"></div>
        <div className="absolute bottom-20 right-10 w-24 h-24 bg-gradient-to-br from-blue-500/10 to-emerald-500/10 dark:from-blue-400/20 dark:to-emerald-400/20 rounded-full blur-xl"></div>
        ...
        <div className="relative z-10 max-w-md mx-auto lg:mx-0 w-full">
          <div className="text-center lg:text-left mb-8">
            <h2 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-slate-800 via-purple-600 to-blue-600 dark:from-slate-100 dark:via-purple-400 dark:to-blue-400 bg-clip-text text-transparent mb-4">
              Welcome Back
            </h2>
            ...
            <div className="relative group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-xl focus:border-purple-500 dark:focus:border-purple-400 focus:ring-2 focus:ring-purple-500/20 dark:focus:ring-purple-400/20 outline-none transition-all duration-200 disabled:bg-slate-50 dark:disabled:bg-slate-900 disabled:text-slate-500 dark:disabled:text-slate-600 text-slate-900 dark:text-slate-100 placeholder:text-slate-500 dark:placeholder:text-slate-400"
                />
              </div>
            </div>
              ...
              <div className="relative group animate-in slide-in-from-top-4 duration-300">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    maxLength={6}
                    className="w-full pl-12 pr-12 py-4 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-xl focus:border-purple-500 dark:focus:border-purple-400 focus:ring-2 focus:ring-purple-500/20 dark:focus:ring-purple-400/20 outline-none transition-all duration-200 font-mono text-center tracking-widest text-slate-900 dark:text-slate-100 placeholder:text-slate-500 dark:placeholder:text-slate-400"
                  />
                  <button
                    type="button"
      ...
      <div className="hidden lg:block w-1/2 h-screen p-6 relative">
        <div className="relative h-full rounded-2xl overflow-hidden shadow-2xl dark:shadow-slate-900/40">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-br from-purple-500/20 via-blue-500/10 to-emerald-500/20 dark:from-purple-400/30 dark:via-blue-400/20 dark:to-emerald-400/30"></div>
          ...
          <div className="absolute top-8 left-8 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl dark:shadow-slate-900/40 max-w-sm border dark:border-slate-700">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-8 h-8 bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg flex items-center justify-center shadow-lg dark:shadow-purple-500/20">
          ...
          <div className="absolute bottom-8 right-8 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl dark:shadow-slate-900/40 max-w-sm border dark:border-slate-700">
            <div className="flex items-center gap-4 mb-4">
              <div className="flex -space-x-2">
                ...
                <div className="w-8 h-8 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full border-2 border-white dark:border-slate-800"></div>
                <div className="w-8 h-8 bg-gradient-to-r from-emerald-400 to-teal-400 rounded-full border-2 border-white dark:border-slate-800"></div>
              </div>
              <div>
